...
if(a<2)j[c]="mouse"+c;else{var d="touch"+("down"===c?"start":"up"===c?"end":c);
// Add fixHook
...
c.disablePan&&c.disableZoom||(h[e]=function(b){var d;("touchstart"===b.type?
// Touch
!(d=b.touches)||(1!==d.length||c.disablePan)&&2!==d.length:
// Mouse/Pointer: Ignore right click
c.disablePan||1!==b.which)||(b.preventDefault(),
// e.stopPropagation(); // why was this here?
a._startMove(b,d))}),this.$elem.on(h),
// Bind reset
...
k.on(f,function(b){b.preventDefault(),a.zoom()}),l.on(f,function(b){b.preventDefault(),a.zoom(!0)})),j.length&&(h={},
// Cannot prevent default action here, just use pointerdown/mousedown
h[(o?"pointerdown":"mousedown")+d]=function(){a.transition(!0)},
// Zoom on input events if available and change events
// See https://github.com/timmywil/jquery.panzoom/issues/90
h[(p?"input":"change")+d]=function(){a.zoom(+this.value,{noSetRange:!0})},j.on(h))}},/**
		 * Unbind all events
		 */
...
this.panning=!0,
// Trigger start event
this._trigger("start",a,d),d&&2===d.length?(h=this._getDistance(d),i=+r[0],j=this._getMiddle(d),e=function(a){a.preventDefault();
// Calculate move on middle point
var b=n._getMiddle(d=a.touches),c=n._getDistance(d)-h;
// Set zoom
n.zoom(c*(p.increment/100)+i,{focal:b,matrix:r,animate:!1}),
// Set pan
n.pan(+r[4]+b.clientX-j.clientX,+r[5]+b.clientY-j.clientY,v),j=b}):(k=a.pageX,m=a.pageY,/**
				 * Mousemove/touchmove function to pan the element
				 * @param {Object} e Event object
				 */
e=function(a){a.preventDefault(),n.pan(t+a.pageX-k,u+a.pageY-m,v)}),
// Bind the handlers
b(l).off(q).on(f,e).on(g,function(a){a.preventDefault(),
// Unbind all document events
b(this).off(q),n.panning=!1,
// Trigger our end event
// Simply set the type to "panzoomend" to pass through all end properties
// jQuery's `not` is used here to compare Array equality
a.type="panzoomend",n._trigger(a,r,!c(r,s))})}},b.Panzoom=g,b.fn.panzoom=function(a){var c,d,e,f;
// Call methods widget-style
// Call methods widget-style
return"string"==typeof a?(f=[],d=n.call(arguments,1),this.each(function(){c=b.data(this,m),c?"_"!==a.charAt(0)&&"function"==typeof(e=c[a])&&
// If nothing is returned, do not add to return values
void 0!==(e=e.apply(c,d))&&f.push(e):f.push(void 0)}),f.length?1===f.length?f[0]:f:this):this.each(function(){new g(this,a)})},g});